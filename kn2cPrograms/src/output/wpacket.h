...
//@mparchin: change for new WB
#define START_BYTE QByteArray::fromHex("AA") // Start of Packet
#define END_BYTE QByteArray::fromHex("55")   // End   of Packet
#define WRITE_REQUEST QByteArray::fromHex("57")
#define READ_REQUEST QByteArray::fromHex("52")
#define DATA_REQUEST QByteArray::fromHex("44")
#define TRANSMIT_ACK QByteArray::fromHex("99")
#define TRANSMIT_NACK QByteArray::fromHex("66")
...
public:
    ...
    //@mparchin: diffrent methode for new WB
    QByteArray getPacketNewWB();
    void Clear();
