...
//    float counter,font;
//    int R,G,B;
//    for(font = -12; font < 12 ; font++){
//     Circle2D circle (Field::ourGoalCenter,(600 + font));
//    for(counter = 0; counter <=180; counter+=0.5){
//        Line2D line (Field::ourGoalCenter , counter);
//        circle.intersection(line,&intersect1 , &intersect2);
//            QPoint targetPoint1(intersect1.x/WORLD_SCALE,intersect1.y/WORLD_SCALE);
//            QPoint targetPoint2(intersect2.x/WORLD_SCALE,intersect2.y/WORLD_SCALE);
//        painter.setBrush(*brush_goals);
//            R=255;
//            G=255;
//            B=200-(counter);
//        painter.setPen(QColor::fromRgb(R,G,B));
//        painter.drawPoint(targetPoint1);
//        painter.setPen(QColor::fromRgb(R,G,B+2*counter-180));
//        painter.drawPoint(targetPoint2);
//    }
//    }
//    QPoint ballPoint (_sc->wm->ball.pos.loc.x/WORLD_SCALE , -_sc->wm->ball.pos.loc.y/WORLD_SCALE);
//    QPoint leftGoal (Field::ourGoalPost_L.x/WORLD_SCALE , Field::ourGoalPost_L.y/WORLD_SCALE);
//    QPoint rightGoal (Field::ourGoalPost_R.x/WORLD_SCALE , Field::ourGoalPost_R.y/WORLD_SCALE);
//    QPoint goalCenter (Field::ourGoalCenter.x/WORLD_SCALE , Field::ourGoalCenter.y/WORLD_SCALE);
//    painter.setPen(QColor::fromRgb(255 , 0 ,0));
//    painter.drawLine(ballPoint , leftGoal);
//    painter.drawLine(ballPoint , rightGoal);

//    painter.drawEllipse(goalCenter , 600/WORLD_SCALE ,600/WORLD_SCALE );
    //draw circle
    Vector2D intersect1 , intersect2;
    float counter,font;
    int R,G,B;
    for(font = -25; font < 25 ; font++){
     Circle2D circle (Vector2D(-2500,0),(1000 + font));
    for(counter = 0; counter <=180; counter+=0.5){
        Line2D line (Vector2D(-2500,0) , counter);
        circle.intersection(line,&intersect1 , &intersect2);
            QPoint targetPoint1(intersect1.x/WORLD_SCALE,intersect1.y/WORLD_SCALE);
            QPoint targetPoint2(intersect2.x/WORLD_SCALE,intersect2.y/WORLD_SCALE);
        painter.setBrush(*brush_goals);
