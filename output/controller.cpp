...
RobotSpeed Controller::calcRobotSpeed_main(ControllerInput &ci)
{
     ...
     */
        ...
        double wkp=1.9,wki_pos=0.18,wki_neg=.2,wkd = 0.1,wki=.001;
        double wa_max = 4;
...
/////////   linear potion profile
       double kp=0.000,ki_pos=0.02,ki_neg=0.06,kd = 0.01;
       double a_max = 0.0015; double a_max_c = 0.001;
       ...
       if( ( fabs( ci.cur_vel.loc.r2()/2/a_max/1.5 )> fabs(err.r()) ) && (diff > 0))
       {
